...
function Notifia () {
    ...
    var roots = {
        ...
        "noticeClasses":" br3 ba b--black-10 notification lang-links br2 ml3 mr3 measures dn fixed justify-left black-50 items-center mt3 ",
        "multiNoticeClasses": [ "halfDim" ],
        "hidingNoticeTimeOff": 3333,
        "fadeClass": "fadePulse",
        "noticeIconClasses": "noticeIcon dib lh-title f3",
        "noticeBodyClasses": "measure lh-title ml2 mt1",
        "noticeSysId": "notifia"
    ...
    var noticeBeginSwitch = function(noticeBundle,returnFor){
        ...
        var noticeAssignment = function(isAciveOrNot, isRemovable, isImportant){
            ...
            var forRet = {
                ...
                "skippable": typeof noticeBundle.skippable !=='undefined'? noticeBundle.skippable : false,
                "beLinkNow": typeof noticeBundle.beLinkNow !=='undefined'? noticeBundle.beLinkNow : false,
            };

            if (typeof noticeBundle.linkIs !== 'undefined'){
                forRet.linkIs = noticeBundle.linkIs;
            }
